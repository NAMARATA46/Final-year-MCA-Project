...
def main_screen():
    ...
    Button(screen, text="ENCRYPTION", height=2, width=20, bg="#ff4f4f", fg="white", bd=0, command=encrypt).place(x=20, y=250)
    Button(screen, text="DECRYPTION", height=2, width=20, bg="#4f98ff", fg="white", bd=0, command=decrypt).place(x=210, y=250)
